<template>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Cadastrar Administrador da Associação</div>
...
<script>
    ...
    roles:'',
        ...
        axios.post('consultarAssociacoes').then(response=>{
        ...
        cadastrarUser(){
          let data = new FormData;
            ...
            axios.post('cadastrarAdma',data).then(response=>{
